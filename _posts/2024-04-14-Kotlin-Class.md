...
<img src="../assets/images/kotlin/field.png" />
...
- 여러 Interface를 구현할 때
  - 모든 interface에 default 구현이 있는 경우 명시적으로 override 해 주어야 하며 새로운 코드를 작성하거나 super<Base> 로 Interface를 지정해 호출할 수 있다
...
<img src="../assets/images/kotlin/impl.png" />
...
<img src="../assets/images/kotlin/conversion.png" />
...
| :----------------------------------------------------------: | :---------------: | :-----------------------------------: | :-------: | :---------: |
| Top-level<br />functions, properties,<br />classes, objects,<br />interfaces |    같은 파일만    |                   -                   | 같은 모듈 |   default   |
|                        Class members                         | 클래스 내부에서만 | 클래스 내부와 자식<br />클래스 에서만 | 같은 모듈 | 모든 곳에서 |
...
<img src="../assets/images/kotlin/delegation.png" />
